<header class="{{ \Route::currentRouteName() == 'index' ? 'absolute' : '' }} w-full z-50 px-4">
            ...
            <div class="w-auto">
                <ul class="fixed bg-white inset-0 flex flex-col invisible items-center justify-center opacity-0 md:visible md:flex-row md:bg-transparent md:relative md:opacity-100 md:flex md:items-center"
                    ...
                    <li class="mx-3 py-6 md:py-0">
                        <a href="#"
                            class="text-black {{ \Route::currentRouteName() == 'index' ? 'md:text-white' : 'md:text-black' }} hover:underline">Showcase</a>
                    </li>
                    <li class="mx-3 py-6 md:py-0">
                        <a href="#"
                            class="text-black {{ \Route::currentRouteName() == 'index' ? 'md:text-white' : 'md:text-black' }} hover:underline">Catalog</a>
                    </li>
                    <li class="mx-3 py-6 md:py-0">
                        <a href="#"
                            class="text-black {{ \Route::currentRouteName() == 'index' ? 'md:text-white' : 'md:text-black' }} hover:underline">Delivery</a>
                    </li>
                    <li class="mx-3 py-6 md:py-0">
                        <a href="#"
                            class="text-black {{ \Route::currentRouteName() == 'index' ? 'md:text-white' : 'md:text-black' }} hover:underline">Rewards</a>
                    </li>
                    @auth
                        <li class="mx-3 py-6 md:py-0">
                            <a href="{{ route('dashboard.index') }}"
                                class="text-black {{ \Route::currentRouteName() == 'index' ? 'md:text-white' : 'md:text-black' }} hover:underline">
                                Dashboard
                            </a>
                        </li>
                    @endauth
                ...
                <ul class="items-center flex">
                    <li class="ml-6 block md:hidden">
                        <button id="menu-toggler"
                            class="relative flex z-50 items-center justify-center w-8 h-8 text-black {{ \Route::currentRouteName() == 'index' ? 'md:text-white' : 'md:text-black' }} focus:outline-none">
                    ...
                    <li class="ml-6">
                        <a id="header-cart"
                            class="flex items-center justify-center w-8 h-8 text-black {{ \Route::currentRouteName() == 'index' ? 'md:text-white' : 'md:text-black' }}"
                            href="{{ route('cart') }}">
