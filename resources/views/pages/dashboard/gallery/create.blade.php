<x-app-layout>
    ...
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            Product &raquo; {{ $product->name }} &raquo; Gallery &raquo; Photos
        </h2>
    </x-slot>
                ...
                <div class="flex flex-warp -mx-3 mb-6">
                    <div class="w-full px-3">
                        ...
                        <input type="file" multiple accept="image/*" name="files[]"
                            class="block w-full bg-gray-200 text-gray-700 border border-gray-200 rounde py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                            placeholder="Photos">
                    </div>
                </div>
                ...
                <div class="flex flex-warp -mx-3 mb-6">
                    <div class="w-full px-3">
                        <button class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded shadow-lg"
                            type="submit">Save Gallery</button>
                    </div>
                </div>
            </form>
        </div>
