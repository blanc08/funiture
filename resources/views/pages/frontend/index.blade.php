    ...
    <section class="flex items-center hero">
        <div class="w-full absolute z-20 inset-0 md:relative md:w-1/2 text-center flex flex-col justify-center hero-caption">
            <h1 class="text-3xl md:text-5xl leading-tight font-semibold">
                The Room <br class="___class_+?27___" />You've Dreaming
            </h1>
        ...
        <div class="container mx-auto">
            <div class="flex flex-start mb-4">
                <h3 class="text-2xl capitalize font-semibold">
                    browse the room <br class="___class_+?43___" />that we designed for you
                </h3>
            </div>
            <div class="grid grid-rows-2 grid-cols-9 gap-4">
                <div class="relative col-span-9 row-span-1 md:col-span-4 card" style="height: 180px">
                    ...
                    <div class="overlay left-0 top-0 bottom-0 flex justify-center flex-col pl-48 md:pl-72">
                        ...
                        <span class="___class_+?50___">18.309 items</span>
                    </div>
                ...
                <div class="relative col-span-9 row-span-1 md:col-span-2 md:row-span-2 card">
                    ...
                    <div
                        ...
                        <span class="___class_+?57___">77.392 items</span>
                    </div>
                    <a href="details.html" class="stretched-link">
                        <!-- fake children -->
                    </a>
                ...
                <div class="relative col-span-9 row-span-1 md:col-span-3 md:row-span-2 card">
                    ...
                    <div
                        class="overlay right-0 left-0 top-0 bottom-0 md:bottom-auto flex justify-center md:items-center flex-col pl-48 md:pl-0 pt-0 md:pt-12">
                        <h5 class="text-lg font-semibold">Living Room</h5>
                        <span class="___class_+?64___">22.094 items</span>
                    </div>
                    <a href="details.html" class="stretched-link">
                        <!-- fake children -->
                    </a>
                ...
                <div class="relative col-span-9 row-span-1 md:col-span-4 card">
                    ...
                    <div class="overlay left-0 top-0 bottom-0 flex justify-center flex-col pl-48 md:pl-72">
                        ...
                        <span class="___class_+?71___">837 items</span>
                    </div>
                    <a href="details.html" class="stretched-link">
                        <!-- fake children -->
                    </a>
    ...
    <section class="flex flex-col py-16">
        <div class="container mx-auto mb-4">
            <div class="flex justify-center text-center mb-4">
                <h3 class="text-2xl capitalize font-semibold">
                    Just Arrived <br class="___class_+?77___" />this summer for you
                </h3>
            </div>
        </div>
        <div class="overflow-x-hidden px-4" id="carousel">
            ...
            <div class="flex -mx-4 flex-row relative">
                ...
                <div class="px-4 relative card group">
                    ...
                    <span class="___class_+?89___">IDR 89.300</span>
                    <a href="#details.html" class="stretched-link">
                        <!-- fake children -->
                    </a>
                </div>
                ...
                <div class="px-4 relative card group">
                    <div class="rounded-xl overflow-hidden card-shadow relative" style="width: 287px; height: 386px">
                        ...
                        <img src="/frontend/images/content/image-arrived-2.png" alt=""
                            class="w-full h-full object-cover object-center" />
                    </div>
                    <h5 class="text-lg font-semibold mt-4">Bankyu Minimay</h5>
                    <span class="___class_+?98___">IDR 67.899</span>
                    <a href="#details.html" class="stretched-link">
                        <!-- fake children -->
                    </a>
                </div>
                ...
                <div class="px-4 relative card group">
                    <div class="rounded-xl overflow-hidden card-shadow relative" style="width: 287px; height: 386px">
                        ...
                        <img src="/frontend/images/content/image-arrived-3.png" alt=""
                            class="w-full h-full object-cover object-center" />
                    </div>
                    <h5 class="text-lg font-semibold mt-4">Buku Sidu Edition</h5>
                    <span class="___class_+?107___">IDR 120.699</span>
                    <a href="#details.html" class="stretched-link">
                        <!-- fake children -->
                    </a>
                </div>
                ...
                <div class="px-4 relative card group">
                    <div class="rounded-xl overflow-hidden card-shadow relative" style="width: 287px; height: 386px">
                        ...
                        <img src="/frontend/images/content/image-arrived-4.png" alt=""
                            class="w-full h-full object-cover object-center" />
                    </div>
                    <h5 class="text-lg font-semibold mt-4">Watch Notes X</h5>
                    <span class="___class_+?116___">IDR 1.973.000</span>
                    <a href="#details.html" class="stretched-link">
                        <!-- fake children -->
                    </a>
                </div>
                ...
                <div class="px-4 relative card group">
                    <div class="rounded-xl overflow-hidden card-shadow relative" style="width: 287px; height: 386px">
                        ...
                        <img src="/frontend/images/content/image-arrived-5.png" alt=""
                            class="w-full h-full object-cover object-center" />
                    </div>
                    <h5 class="text-lg font-semibold mt-4">Racking Plants</h5>
                    <span class="___class_+?125___">IDR 599.400</span>
                    <a href="#details.html" class="stretched-link">
                        <!-- fake children -->
                    </a>
                </div>
                ...
                <div class="px-4 relative card group">
                    ...
                    <h5 class="text-lg font-semibold mt-4">Racking Plants</h5>
                    <span class="___class_+?134___">IDR 599.400</span>
                    <a href="#details.html" class="stretched-link">
                        <!-- fake children -->
                    </a>
                </div>
                ...
                <div class="px-4 relative card group">
                    ...
                    <h5 class="text-lg font-semibold mt-4">Racking Plants</h5>
                    <span class="___class_+?143___">IDR 599.400</span>
                    <a href="#details.html" class="stretched-link">
                        <!-- fake children -->
                    </a>
                </div>
